...
class SubCategoryController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.sub-category.create', $data, compact('subCategories'));
    }
    ...
    public function edit($id)
    {
        ...
        if (empty($subCategory)) {
            return redirect()->route('sub-categories.index')->with('error', 'Category Not Found');
        }
