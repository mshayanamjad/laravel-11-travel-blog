    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <form action="" method="get">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" class="btn btn-secondary btn-md" onclick="window.location.href='{{ route('sub-categories.create') }}'">Reset</button>
                    </div>
            ...
            <div class="card-body table-responsive p-0">
                <table class="categoriesTable table table-hover text-nowrap table-striped">
                    <thead>
                        <tr>
                            <th width="60">Sr.</th>
                            <th>Name</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <form action="{{ route('sub-categories.delete', $subCategory->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
