    ...
    <div class="container-fluid">
        <form action="" method="post" name="postForm" id="postForm" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-body">	
                            ...
                            <a href="{{ route('editor-sub-categories.create') }}">+Add Sub Category</a>
                        </div>
                    </div> 
                    <div class="card mb-3">
                        <div class="card-body">	
            ...
            <div class="col-md-8 pb-5 pt-3 d-flex d-md-none">
                <button class="btn btn-primary">Create</button>
                <a href="{{ route('editor-posts.create') }}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.status == true) {
                ...
                window.location.href = "{{ route('editor-posts.create') }}";
            } else {
