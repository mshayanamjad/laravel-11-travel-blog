...
<!--  Header Start Here -->
<section class="video-section about-hero-sec">
    <div class="container">
    <div class="row">
        <div class="image-slider">
        <div><img src="{{ asset('front-assets/images/about-1.jpg') }}" /></div>
        <div><img src="{{ asset('front-assets/images/about-2.jpg') }}" /></div>
        <div><img src="{{ asset('front-assets/images/gallery.webp') }}" /></div>
        </div>
        <!--  Image slider Start Here -->
        <div class="slider-content">
        <h1 class="h1-title blog">About</h1>
        <p class="slider-text">More about me</p>
        </div>
    </div>
    </div>
</section>
<!--  Section 1 End Here -->
<section class="shape-divider">
    <svg
...
<section class="about py-5">
    <div class="container">
        <div class="d-flex flex-column align-items-start justify-content-between flex-md-row">
            <div class="col-12 col-md-6 pe-2">
                <h2 class="about-heading">About me</h2>
                <div class="styled-title about-style-right">
                    <h2 class="">David</h2>
                </div>
                <div class="about-text">
                    <p>Thanks for looking! I'm <strong>David Leiter</strong>, and this is my <a>travel blog</a>.</p>

                    <p>I'm an American who's been traveling the world full time for 9 years. Nowadays, I'm usually in <a>Bali, Indonesia</a>, with my wife Intan.</p>

                    <p>I first fell in love with travel on a solo road trip across <a>Iceland</a> in 2016. My budget was small, so I slept in the back of a rental car for 1 month while I drove 7,000 kilometers around the country, filming all the scenic places in Iceland.</p>

                    <p>One of my first videos racked up a few million views and was featured on international TV by <a>BBC Travel</a>.</p>

                    <p>Since then I've solo traveled to many developing countries, including almost every country in Asia, Central America, and the Middle East.</p>

                    <p>I experienced the <a>7.0 Lombok earthquake in Indonesia in 2018</a>, the bombings in Bangkok in 2019, and a fair share of scams, fights, sicknesses, car accidents, and other crazy things along the way.</p>

                    <p>It hasn't always been easy, but over the years I've been blessed with some amazing experiences, including:</p>

                    <p>
                        <ul>
                            <li><a>Hiking to Mount Everest Base Camp</a> in the Himalayas</li>
                            <li><a>Climbing an erupting volcano</a> in Guatemala</li>
                            <li><a>Trekking on glaciers</a> in <a>Patagonia</a> and visiting the <a>Iguazu Falls</a> in Argentina</li>
                            <li><a>Seeing wild Komodo dragons</a> and <a>orangutans</a> in Indonesia</li>
                            <li><a>Sleeping in treehouses</a> in Bali and <a>seeing blue fire</a> in Java</li>
                            <li><a>Dining on tarantulas and scorpions</a> in Cambodia</li>
                            <li><a>Riding a camel to the Great Pyramids of Giza</a> in Egypt</li>
                            <li>Skydiving over paradise in <a>Oahu Hawaii</a></li>
                           <li>And visiting some timeless world monuments like 
                                <a>Taj Mahal</a>, 
                                <a>Tikal</a>, 
                                <a>Bagan</a>, 
                                <a>Machu Picchu</a>, 
                                ...
                                <a>Angkor Wat</a>, 
                                <a>Petra</a>, 
                                and <a>Himeji Castle</a>
                            </li>

                        </ul>
                    </p>
                    <p>In 2018, I traveled to 24 countries in one year, which is a personal record so far! I did this on a pretty modest budget and rarely spent more than $30/day on my travels, including lodging and food.</p>

                    <p>I haven't been everywhere, but <a>it's on my list!</a> I'm always looking for new adventures.</p>

                    <p>I hope my <a>travel blog</a> can help and inspire you in your own journeys as well!</p>
                </div>
                <div class="social-links mt-5 mb-5 mb-md-0">
            ...
            <div class="col-12 col-md-6 about-images">
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-21.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-15.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/asset 13.jpeg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-13.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-18.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-9.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-16.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-14.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-17.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-12.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-11.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-10.jpg') }}" class="img-fluid" alt="About Us">
                </div>
            </div>
        </div>
    </div>
...
<section class="featured pb-5">
    <div class="container">
        <div class="d-flex flex-column align-items-start justify-content-between flex-md-column">
            <div class="col-12 col-md-12 mb-5 styled-title">
                <h2>Featured</h2>
            </div>
            <div class="col-12 col-md-12 slider d-flex align-items-center justify-content-center flex-wrap gap-4 gap-md-5">
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-1.png') }}" class="img-fluid" alt="featured 01">
                </div>
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-2.jpeg') }}" class="img-fluid" alt="featured 02">
                </div>
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-3.jpeg') }}" class="img-fluid" alt="featured 03">
                </div>
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-4.jpeg') }}" class="img-fluid" alt="featured 04">
                </div>
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-5.jpeg') }}" class="img-fluid" alt="featured 05">
                </div>
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-6.jpg') }}" class="img-fluid" alt="featured 06">
                </div>
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-7.jpg') }}" class="img-fluid" alt="featured 07">
                </div>   
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-8.png') }}" class="img-fluid" alt="featured 08">
                </div>
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-9.jpg') }}" class="img-fluid" alt="featured 09">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-10.jpg') }}" class="img-fluid" alt="featured 10">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-11.jpg') }}" class="img-fluid" alt="featured 11">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-12.jpg') }}" class="img-fluid" alt="featured 12">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-13.jpg') }}" class="img-fluid" alt="featured 13">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-14.png') }}" class="img-fluid" alt="featured 14">
                </div> 

                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-15.jpg') }}" class="img-fluid" alt="featured 15">
                </div>

                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-16.png') }}" class="img-fluid" alt="featured 16">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-17.jpg') }}" class="img-fluid" alt="featured 17">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-18.jpg') }}" class="img-fluid" alt="featured 18">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-19.png') }}" class="img-fluid" alt="featured 19">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-20.png') }}" class="img-fluid" alt="featured 20">
                </div>
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-21.png') }}" class="img-fluid" alt="featured 21">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-22.png') }}" class="img-fluid" alt="featured 22">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-23.png') }}" class="img-fluid" alt="featured 23">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-24.jpg') }}" class="img-fluid" alt="featured 24">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-25.jpg') }}" class="img-fluid" alt="featured 25">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-26.jpg') }}" class="img-fluid" alt="featured 26">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-27.png') }}" class="img-fluid" alt="featured 27">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-28.webp') }}" class="img-fluid" alt="featured 28">
                </div> 
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-29.webp') }}" class="img-fluid" alt="featured 29">
                </div>
                <div class="slides">
                    <img src="{{ asset('front-assets/images/logo-30.webp') }}" class="img-fluid" alt="featured 30">
                </div> 
            </div>
        </div>
    </div>
...
<!--  Section 4 End Here -->
<section class="collab py-5">
    <div class="container">
        <div class="d-flex flex-column align-items-start justify-content-between flex-md-row">
            <div class="col-12 col-md-6 pe-4">
                <h2 class="about-heading">Work With Me</h2>
                <div class="styled-title about-style-right">
                    <h2 class="">Collabs</h2>
                </div>
                <div class="about-text">
                    <p>As an experienced traveler with a modest budget and a passion for hiking and photography, my work meshes with young people, backpackers, couples, and other important travel demographics.</p>

                    <p>Together with your brand, we can create engaging experiences that will reach like-minded travelers and help you sell your products or promote your travel destination.</p>

                    <p>This blog has up to 350,000 readers per month. My goal is to create unique and fresh travel content and photos from around the world, with an emphasis on quality over quantity.</p>

                    <p>I do all of the writing and <a>photography</a> on this website myself. I never use AI writing or stock photos unless otherwise noted, and I plan to keep it that way. Everything on my blog comes from my own personal experience.</p>

                    <p>I'm also an FAA Part 107 trained and certified drone pilot for doing commercial work with drones in the United States.</p>

                    <p>My past work has been featured by some big names in the travel industry, such as <a>Travel + Leisure</a> and <a>BBC Travel</a>, and my videos have racked up more than 20 million views on Facebook via companies like <a>UNILAD Adventure</a> and <a>Must Do Travels.</a></p>

                    <p>Over the years, I've also partnered with hotels, tourism bureaus, and some great equipment brands like <a>Napier Outdoors.</a></p>

                    <p>You can be next! Feel free to contact me using the form below!</p>

                </div>
            </div>
            <div class="col-12 col-md-6 about-images">
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-6.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-19.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-4.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-7.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-20.webp') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-5.jpg') }}" class="img-fluid" alt="About Us">
                </div>
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/about-3.jpg') }}" class="img-fluid" alt="About Us">
                </div>
            </div>
        </div>
    </div>
...
<section class="contact py-5">
    <div class="container">
        <div class="d-flex flex-column align-items-start justify-content-between flex-md-row">
            <div class="col-12 d-none d-md-block col-md-3 contact-images">
                <div class="gallery">
                    <img src="{{ asset('front-assets/images/contact.jpg') }}">
                </div>
            </div>
            <div class="col-12 col-md-9 ps-0 ps-md-4">
                <h2 class="about-heading">Contact</h2>
                <div class="styled-title about-style-right mb-4">
                    <h2 class="">Let's talk!</h2>
                </div>
                <div class="contact-form">
                    @include('front.layouts.contact-form')
                </div>
            </div>
        </div>
    </div>
