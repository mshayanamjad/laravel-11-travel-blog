...
<!--  Header Start Here -->
<section class="video-section blog-hero-sec contact-hero-sec">
    <div class="container">
        <div class="row">
            <div class="slider-content">
                <h1 class="h1-title blog">Contact</h1>
                <p class="slider-text mb-0">Send me your questions, comments, or suggestions!</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="d-flex flex-column align-items-center justify-content-center">
            <div class="col-12 col-md-7 p-0">
                <h2 class="about-heading text-center">Get In Touch</h2>
                <div class="styled-title about-style-right mb-4 w-100">
                    <h2 class="">Contact Form</h2>
                </div>
                <div class="about-text text-center">
                    <p>Send me your questions, comments, or suggestions!</p>
                    <p>If you'd like to work with me or you have a question or comment, you can contact me using the form below. You can also find <a>more info about me here.</a></p>
                    <p>Sometimes I'm busy traveling, but I try to respond to any messages!</p>
                </div>
                <div class="contact-form mt-3 mt-md-5">
    ...
    <div class="container">
        <div class="d-flex flex-column align-items-start justify-content-between">
            <div class="col-12 col-md-12">
                ...
                <div class="faq-container mt-3 mt-md-4">
                    <div class="faq">
                      <div class="faq-question">
                        <span>Do you accept guest blogs?</span>
                        <span class="icon">&#43;</span>
                      </div>
                      <div class="faq-answer">No, I do not accept guest blog posts on my site. I do all of the writing myself.</div>
                    </div>
                    <div class="faq">
                      <div class="faq-question">
                        <span>Can I quote you as an expert source?</span>
                        <span class="icon">&#43;</span>
                      </div>
                      <div class="faq-answer">Sure, I'm generally happy to provide a quote as an expert source in your article for topics like travel, hiking, gear, culture, and more.<br>I've been referenced or featured by many media outlets including TIME, USA Today, NBC News, BBC Travel, Travel+Leisure, and lots of international tourism bureaus.</div>
                    </div>
                    <div class="faq">
                      <div class="faq-question">
                        <span>Can I buy drone footage from you?</span>
                        <span class="icon">&#43;</span>
                      </div>
                      <div class="faq-answer">Sure, just send me a note letting me know what footage you’re interested in!</div>
                    </div>
                    <div class="faq">
                      <div class="faq-question">
                        <span>What camera/drone do you use?</span>
                        <span class="icon">&#43;</span>
                      </div>
                      <div class="faq-answer">At the moment I use a <a href="#">Fujifilm X-T5 camera</a> and a DJI Air 3S drone, although most of the pics on this site were taken with my older X-T2 and Mavic 2 cameras. You can find more info about the rest of my travel gear <a href="#">here</a>.</div>
                    </div>
                    <div class="faq">
                        <div class="faq-question">
                            <span>How did you start traveling?</span>
                            <span class="icon">&#43;</span>
                        </div>
                        <div class="faq-answer">
                        I fell in love with travel during a 2015 hiking trip to the rocky mountains in Colorado.

                        The next year, I did my first major international trip — a solo road trip across <a href="#">Iceland</a>.<br>

                        My budget was small, so I slept in the back of a rental car for 1 month while I drove 7,000 kilometers around the entire country, filming all of the scenic places in Iceland.

                        You can read more of my story <a href="#">here</a>.
                        </div>
                    </div>
                    <div class="faq">
                      <div class="faq-question">
                        <span>What’s your favorite place to travel?</span>
                        <span class="icon">&#43;</span>
                      </div>
                      <div class="faq-answer">
                        <a href="#">Bali</a>, of course! That's why it's our second home between travels. Bali is budget friendly, warm, and there's so much to see and do. I also love the people of Bali and that's why I married one of them. 🙂<br>
                        Outside of Bali, we’ve really enjoyed places like Japan, Egypt, Myanmar, Hawaii, etc. There are very few places we’ve traveled that we didn’t like in some way or another, even in spite of their flaws.
                      </div>
                    </div>
                    <div class="faq">
                        <div class="faq-question">
                            <span>Where do you book hotels?</span>
                            <span class="icon">&#43;</span>
                        </div>
                        <div class="faq-answer">
                          <a href="https://www.booking.com/index.html?aid=1687967">Booking.com</a> is my preference for international travel. Their pricing is more transparent and they usually have the best terms.
                        </div>
                    </div>
                    <div class="faq">
                        <div class="faq-question">
                            <span>Do you write with AI?</span>
                            <span class="icon">&#43;</span>
                        </div>
                        <div class="faq-answer">
                          No, I never use AI writing or stock photos unless otherwise noted, and I plan to keep it that way. Everything on my blog comes from my own personal experience.
                        </div>
                    </div>
                    <div class="faq">
                        <div class="faq-question">
                            <span>What do you use for editing photos/videos?</span>
                            <span class="icon">&#43;</span>
                        </div>
                        <div class="faq-answer">
                          I use <strong>Adobe Lightroom</strong> for editing photos, and <strong>Adobe Premiere</strong> for videos.
                        </div>
                    </div>
                    <div class="faq">
                        <div class="faq-question">
                            <span>Do you have social media?</span>
                            <span class="icon">&#43;</span>
                        </div>
                        <div class="faq-answer">
                          You can find me on Facebook, Instagram, Pinterest, and YouTube.
                        </div>
                    </div>
                </div>
